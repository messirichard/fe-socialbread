    ...
    return(
        <div>
            ...
            <section className="about-us section-1 md:pt-36">
                <div className="grid md:grid-cols-2 bg-purple-100">
                    ...
                    <div>
                        <img src="img/IMG-About-Us.png" className=""></img>
                    </div>
            ...
            <section className="about-us section-2">
                <div className="md:container mx-auto px-4 text-center mb-6 md:mb-20">
            ...
            <section className="about-us section-4 mb-8 md:mb-36">
                <div className="grid grid-cols-2">
                    <div className="block md:hidden col-span-2 md:col-span-1">
                        <div className="max-w-xl inline-block relative inset-0 m-auto">
                            <h2 className="text-4xl md:text-6xl font-medium color__green mb-5 md:mb-12">
                                About Us
                            </h2>
                            <p className="text-sm md:text-lg text_color_grey_3 leading-7 max-w-lg">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque nisi ullamcorper tellus, ipsum volutpat. In eget volutpat lorem rhoncus proin enim, ac orci non. Velit leo mi metus rutrum a, nulla semper leo. Orci, vitae bibendum turpis pellentesque augue.
                            </p>
                        </div>
                    </div>
                    <div className="block md:hidden col-span-2 md:col-span-1">
                        <img src="img/IMG-Vision.png">
                        </img>
                    </div>
                    <div className="block md:hidden col-span-2 md:col-span-1">
                        <img src="img/IMG-Vision.png">
                    ...
                    <div className="max-w-xl hidden md:inline-block relative inset-0 m-auto">
