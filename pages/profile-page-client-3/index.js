    ...
    <div>
        ...
        <div className="md:container mx-auto px-5 mb-8 md:mb-32 md:pt-64">
            ...
            <div className="rounded-xl border mb-9">
                <div className="grid grid-cols-12 py-4 px-3 md:py-8 md:pl-14 md:pr-16">
                ...
                <div className="grid grid-cols-12 py-4 md:py-10 px-3 md:pl-14 md:pr-16">
                    <div className="col-span-0 md:col-span-6">
                    </div>
