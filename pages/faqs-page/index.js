...
return (
    <div>
        <Navbar></Navbar>
        <div className="md:container mx-auto px-4 pt-10 md:pt-80 pb-10 md:pb-36">
            <h1 className="text-6xl md:text-8xl font-medium color__green mb-4">
                FAQs
            </h1>
            <p className="text-sm md:text-lg text_color_grey_3 font-medium mb-4">
                Frequently Asked Questions
            </p>
            <p className="text-sm md:text-lg text_color_grey_3 font-normal mb-12">
            ...
            text-lg md:text-2xl font-medium justify-between text_color_green_2 border-t-2"
            role="alert">
            ...
            <div class="text-lg md:text-2xl font-medium bg-white  bg-opacity-50 duration-300 py-4 rounded-lg rounded-b-none flex 
            justify-between text_color_green_2 border-t-2"
            role="alert">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis eu rhoncus arcu, faucibus ?
            <i class="fas fa-chevron-up"></i>
            </div>
            <div class=" bg-opacity-50 border-b-2 rounded-b-lg text-sm md:text-lg text_color_grey_3 pt-5 pb-8 md:pr-96">
