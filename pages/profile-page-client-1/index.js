        ...
        <div className="md:container mx-auto px-5 mb-8 md:mb-32 md:pt-64">
                        ...
                        <div className="grid grid-cols-6 md:grid-cols-5">
                            ...
                            <div className="col-span-4 md:col-span-3 md:pr-8">
                                ...
                                <div class="relative pt-1">
                                    <div class="overflow-hidden h-3.5 mt-2 md:mt-4 text-xs flex rounded bg_color_grey_3">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-span-full md:col-span-3 relative">
                        <div className="grid grid-cols-8 gap-x-4 mt-3 pt-3 md:pt-auto">
                            ...
                            <div className="col-span-4 md:col-span-5">
                                <button className="text-xs md:text-sm text_color_white bg_color_green_2 py-2 md:py-3  text-center rounded-xl w-full">
                                    View Detail
                                </button>
                            </div>
                        </div>
            ...
            <div className="rounded-xl border py-4 md:py-8 px-3 md:pl-14 md:pr-16 mb-5">
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-full md:col-span-3 relative">
                        <div className="grid grid-cols-8 md:grid-cols-7 gap-x-4 mt-3 pt-3 md:pt-auto">
                            <div className="col-span-4 md:col-span-4">
                                <button className="text-xs md:text-sm text_color_green_2 py-2 md:py-3 border_color_green_2 text-center rounded-xl w-full">
                                    Pengembalian Dana
                                </button>
                            </div>
                            <div className="col-span-4 md:col-span-3">
