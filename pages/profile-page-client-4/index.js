            ...
            <div className="grid grid-cols-12 md:grid-cols-9 md:gap-x-28">
                <div className="col-span-12 md:col-span-2">
                        ...
                        <div className="col-span-full md:col-span-3 pt-7">
                            <div className="grid grid-cols-12 gap-x-3">
                                ...
                                <div className="col-span-4">
                                    <button className="text-sm text_color_white bg_color_green py-1 px-3 text-center rounded-md w-full">
                                        <img src="img/bx_bxs-download.png" className="inline-block mr-3 w-4 h-4"></img>
                                        <p className="text-xs md:text-2xl text-white inline-block">
                                            Invoice
                                        </p>
                                    </button>
                                </div>
                    ...
                    <div className="grid grid-cols-8 md:grid-cols-1 md:gap-x-auto gap-x-12">
                        ...
                        <div className="col-span-4 md:col-span-full">
                            <p className="text-sm md:text-lg font-semibold text_color_grey_2 mt-3 md:mt-10">
                                Content Creator
                            </p>
                            <a href="#">
                ...
                <div className="col-span-12 md:col-span-7">
                        ...
                        <div className="col-span-full md:col-span-3 pt-7">
                            <div className="grid grid-cols-9">
                                ...
                                <div className="col-span-5">
                                    <button className="text-sm text_color_white bg_color_green py-3 px-7 text-center rounded-xl w-full">
                                        <img src="img/bx_bxs-download.png" className="inline-block -mt-3 mr-5"></img>
                                        <p className="text-2xl text-white inline-block">
                                            Invoice
                                        </p>
                                    </button>
                                </div>
                    ...
                    <div className="grid grid-cols-6 md:grid-cols-6 mb-7 md:mb-11 pt-7 md:pt-12">
                        <div className="col-span-6">
                            <div className="grid grid-cols-6 md:grid-cols-7">
                                <div className="col-span-3 md:col-span-1">
                                    ...
                                    <p className="text-sm mb-3 md:mb-auto md:text-lg mt-2">
                                        Posted Content
                                    </p>
                                </div>
                                ...
                                <div className="col-span-6 block md:hidden">
                                    <div className="grid grid-cols-3 gap-x-2">
                                        <div className="col-span-1">
                                            <button className="py-1 px-3 rounded bg_color_blue_2 border w-full">
                                                <p className="text-xs color__green font-medium text-center">
                                                    Influencer 1
                                                </p>
                                            </button>
                                        </div>
                                        <div className="col-span-1">
                                            <button className="py-1 px-3 rounded border w-full">
                                                <p className="text-xs color__green font-normal text-center">
                                                    Influencer 2
                                                </p>
                                            </button>
                                        </div>
                                            ...
                                            <button className="py-1 px-3 rounded border w-full">
                                                <div className="grid grid-cols-12 gap-x-2">
                                                    <div className="col-span-3">
                                                        <img className="w-full" src="img/Rectangle-180.png">
                                                        </img>
                                                    </div>
                                ...
                                <div className="col-span-3 md:col-span-2 md:pl-20 hidden md:block">
                                    <p className="text-lg font-semibold text_color_grey_2">
                                        Content Creator
                                    </p>
                                    <a href="#">
                                        <div className="grid grid-cols-4 gap-x-5 gap-y-5 pt-4">
                                            <div className="col-span-1">
                                                <img className="mt-1 w-100" src="img/Rectangle-180.png">
                                                </img>
                                            </div>
                    ...
                    <div className="rounded-xl bg_color_blue border pt-5 pb-4 px-3 md:pl-14 md:pr-16 mb-4">
                        <div className="grid-cols-10 hidden md:grid">
                            ...
                            <div className="col-span-10 md:col-span-2">
                                <p className="text-sm md:text-lg color__green inline-block mt-2">
                                    tiktok.com/akkkAAAA
                                </p>
                            </div>
                        </div>
                        <div className="grid grid-cols-12 md:hidden">
                            ...
                            <div className="col-span-10 md:col-span-4 pl-3">
                                <p className="text-xs md:text-lg color__green inline-block">
                                    Yolia Kristanto
                                </p>
                                <p className="text-xs color__green mt-2">
                                    Submited: 20/06/21, 12.30 PM
                                </p>
                                <p className="text-xs md:text-lg color__green inline-block mt-2">
                                    tiktok.com/akkkAAAA
                                </p>
                            </div>
                            <div className="col-span-10 md:col-span-2">
                    ...
                    <h3 className="text-lg md:text-5xl font-semibold color__green mt-6 md:mt-12 mb-9 md:mb-16">
                        Pesan
                    </h3>
                    <div className="grid grid-cols-12 gap-x-2">
                    ...
                    <div className="grid grid-cols-6 md:grid-cols-6 mb-7 md:mb-11 pt-12">
                        <div className="col-span-6">
                            <div className="grid grid-cols-6 md:grid-cols-7">
                                <div className="col-span-3 md:col-span-1">
                                    <h3 className="text-5xl md:text-7xl color__green">
                    ...
                    <h3 className="text-2xl md:text-5xl font-semibold color__green mt-8 md:mt-12 mb-9 md:mb-16">
                        Pesan
                    </h3>
                    <div className="grid grid-cols-12 gap-x-2">
                        <div className="col-span-2">
                    ...
                    {/* <div className="grid grid-cols-6 mb-11 pt-12">
                        <div className="col-span-6">
                            <div className="grid grid-cols-7">
                                <div className="col-span-1">
                                    <h3 className="text-7xl color__green">
                                        3
                                    </h3>
                                    <p className="text-lg mt-2">
                                        Posted Content
                    ...
                    <div className="rounded-xl bg_color_blue border pt-5 pb-4 pl-14 pr-16 mb-4">
                        <div className="grid grid-cols-10">
                            <div className="col-span-4">
                                <img className="w-14 h-14 rounded-full inline-block mr-5" src="img/Rectangle-180.png">
                                </img>
                            ...
                            <div className="col-span-2">
                                <p className="text-lg color__green inline-block mt-2">
                                    tiktok.com/akkkAAAA
                                </p>
                            </div>
                        </div>
                    ...
                    <h3 className="text-5xl font-semibold color__green mb-16 mt-12">
                        Pesan
                    </h3>
                    <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-10 mb-11">
                            <h4 className="text-2xl color__green font-semibold mb-5">
                                Wowteg
                            </h4>
                            <div className="px-16 py-6 bg_color_green_2 rounded-t-3xl rounded-br-3xl">
                                <p className="text-lg text_color_white_2 ">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Turpis vulputate turpis tempor nisi, 
                                    magna eget eget. Sit ut quis aliquam laoreet phasellus. Eget accumsan, posuere ut pulvinar suscipit 
                                    nulla. Lacus amet, tincidunt ac neque maecenas sit. Condimentum aliquet donec pretium, quis proin ac 
                                    elit cras gravida. Massa tempus dis dui enim, metus nunc sed lorem. Adipiscing nisl viverra amet, ut quam 
                        ...
                        <div className="col-span-10 mb-11">
                            <h4 className="text-2xl color__green font-semibold mb-5 text-right">
                                Yolia Kristanto
                            </h4>
                            <div className="px-16 py-6 bg_color_blue rounded-t-3xl rounded-bl-3xl">
                                <p className="text-lg color__green">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Turpis vulputate turpis tempor nisi, 
                                    magna eget eget. Sit ut quis aliquam laoreet phasellus. Eget accumsan, posuere ut pulvinar suscipit 
                                    nulla. Lacus amet.
                                </p>
...
export default profilePageClient4;